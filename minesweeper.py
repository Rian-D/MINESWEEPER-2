...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        """
        self.moves_made.add(cell) # mark the cell as one of the moves made in the game

        self.mark_safe(cell) # mark the cell as a safe cell, updating any sequences that contain the cell as well
